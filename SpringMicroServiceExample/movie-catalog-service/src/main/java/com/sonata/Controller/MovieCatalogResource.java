...
//		return ratings.stream().map(rating->new CatalogItem("spiderman","This is not my movie",4)).collect(Collectors.toList());
		...
		return ratings.getUserRating().stream().map(rating->
		{
			...
			return new CatalogItem(movie.getName(),"this is my new movie",rating.getRating());
